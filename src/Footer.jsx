    ...
    <div>
      <div className="container-fluid bg-gray-100">
        <div className="container py-5">
          <div className="row border-b-2 border-b-gray-200 text-lg-start text-center">
            <div className="col-lg-5 col-12 py-5">
              <p className="text-4xl">Strada</p>
              <p className="text-xl text-gray-500 fw-light py-4">
                Crafting exceptional digital experiences through thoughtful
                design and innovative solutions that elevate your brand
                presence.
              </p>
              <p className="flex gap-2 justify-content-lg-start justify-content-center">
                {" "}
                <svg
              ...
              <p className="flex gap-2 justify-content-lg-start justify-content-center">
                <svg
                  ...
                  height={20}
                  fill="currentColor"
                  className="bi bi-telephone text-green-600"
                  viewBox="0 0 16 16"
                >
              ...
              <p className="flex gap-2 justify-content-lg-start justify-content-center">
                <svg
                  ...
                  height={20}
                  fill="currentColor"
                  className="bi bi-envelope  text-green-600 fw-bold"
                  viewBox="0 0 16 16"
                >
          ...
          <div className="py-5 flex flex-lg-row flex-column justify-content-lg-between border-b-2 border-b-gray-200 flex-lg-nowrap flex-wrap ">
            <div>
              <p className="text-xl text-lg-start text-center">Stay Inspired</p>
              <p className="text-gray-500 text-lg-start text-center">
                Subscribe to receive design insights and <br /> creative
